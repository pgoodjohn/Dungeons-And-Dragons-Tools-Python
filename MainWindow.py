...
import sys
import os
sys.path.insert(0, '/Users/pietrobongiovanni/GitHub/Dungeons-And-Dragons-Tools-Python/WeaponGenerator')
...
sys.path.insert(0, '/Users/pietrobongiovanni/GitHub/Dungeons-And-Dragons-Tools-Python/NPCGenerator')
import npcgenerator as npc

#http://stackoverflow.com/questions/17069352/problems-remains-inserting-two-different-classes-within-the-same-frame-into-a-no

#http://stackoverflow.com/questions/22785949/subclassing-with-tkinter-in-python

#http://pythonprogramming.net/object-oriented-programming-crash-course-tkinter/
...
class DiceRoller(tk.Frame):
    def __init__(self,root):
        ...
        #Text Result
        self.text.grid(row = 0, column = 3, rowspan = 6)
...
class NameGenerator(tk.Frame):
    def __init__(self,root):
        ...
        self.text = Text(self)
        self.text.config(state=DISABLED)
        self.text.config(height = 6, width = 25)
...
class NPCGenerator(tk.Frame):
    def __init__(self,root):
        ...
        generate = Button(self, text = 'Generate', command = self.GenerateRandom)
        ...
        self.text.grid(row = 0, column = 0, sticky = E+W)
        generate.grid(row = 0, column = 1, sticky = E)
        quit.grid(row = 1, column = 0, sticky = E)

    def GenerateRandom(self):
        string = npc.generateNPC()
        self.text.config(state=NORMAL)
        self.text.delete(1.0, END)
        self.text.insert(INSERT, string)
        self.text.config(state=DISABLED)
